  ...
  return (
    <div className="flex flex-1 flex-col gap-4 p-4">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Dashboard PMI Tangsel</h1>
          <p className="text-muted-foreground">
            Sistem Informasi Posko PMI Kota Tangerang Selatan
          </p>
        </div>
        <div className="flex items-center space-x-4">
          <img src="/images/logo pmi-tangsel.png" alt="PMI Logo" className="h-20 drop-shadow-lg" />
        </div>
      </div>
      ...
      <Card className="w-full overflow-hidden">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle>Peta Interaktif Kota Tangerang Selatan</CardTitle>
          <Button
            variant="outline"
            size="sm"
            onClick={() => setShowStats(!showStats)}
            className="bg-background/90 backdrop-blur supports-[backdrop-filter]:bg-background/60 border shadow-lg"
          >
        ...
        <CardContent className="p-0">
          <div className="relative w-full h-[700px] rounded-xl overflow-hidden border">
            ...
            {/* FLOATING STATS - LEFT AND RIGHT COLUMNS */}
            {showStats && (
              <>
                {/* LEFT COLUMN - EMERGENCY CONTACTS & SUPPORT */}
                <div className="absolute top-6 left-6 bottom-6 z-20 w-80">
                ...
                <div className="absolute top-6 right-6 bottom-6 z-20 w-96">
                  <div className="grid grid-cols-1 gap-1 h-full">
